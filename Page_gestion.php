...
<body>
    ...
    <div class="options1">
        <div class="center_element">
            ...
            <a href="Acceuil.html">Contacts</a>
                   ...
                   <ul>
                     ...
                     <?php
                        ...
                        if (isset($_SESSION['codeAgent']))  //if the user is logged in
                        {
                            ...
                            {
                                echo "<li><a href='listeoffense.php'><ion-icon name='clipboard-outline'></ion-icon></i> Lister offense</a></li>"; //<!-- the clipboard list icons-->
                                echo "<li><a href='conducteur_page.php'><ion-icon name='person-outline'></ion-icon></i> Ajouter un conducteur</a></li>";  //<!-- the user icons-->
                                echo "<li><a href='listeoffense.php'><ion-icon name='newspaper-outline'></ion-icon></i> Lister utilisateur</a></li>";  //<!-- the scroll looking icons-->
                                echo "<li><a href='agent_page.php'><ion-icon name='newspaper-outline'></ion-icon></i> Enregistrer agent</a></li>";  //<!-- the scroll looking icons-->
                            }
                        }
                     ?>
